...
class _ManagePractionerDesktopState extends State<ManagePractionerDesktop> {
                          ...
                          child: Consumer(
                            builder: (context, ref, child) {
                              ...
                              return practioners.when(
                                data: (data) {
                                  final Iterable<Practioner> practionersData =
                                      data;
                                  ...
                                  return data.isNotEmpty
                                      ? ListView.builder(
                                          ...
                                          itemCount: practionersData.length,
                                          itemBuilder: (context, indexs) {
                                            final practioner = practionersData
                                                .elementAt(indexs);
                                            return _buildTableUser(context,
                                                practioner, indexs, ref);
                                          },
                                        )
                                      : Center(
                                          child: ListView(
  ...
  _buildTableUser(
      BuildContext context, Practioner practioner, int indexs, WidgetRef ref) {
    double screenWidth = MediaQuery.of(context).size.width;
    double width = ResponsiveWidget.isphoneScreen(context)
        ? 414
        : ResponsiveWidget.isSmallScreen(context)
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () {
                          dialogEditPractioner(context, ref, practioner);
                          setState(() {
                            userId = practioner.userId;
                            _firstNamePractioner.text = practioner.firstName;
                            _lastNamePractioner.text = practioner.lastName;
                            _myApproachPractioner.text = practioner.myApproach;
                            _myBackgroundPractioner.text =
                                practioner.myBackground;
                            _myQualificationsPractioner.text =
                                practioner.myQualifications;
                            _mySpecialtyPractioner.text =
                                practioner.mySpecialty;
                            _myRolesPractioner.text = practioner.myRoles;
                            _languagesPractioner.text = practioner.languages;
                            _titleMainPractioner.text = practioner.titleMain;
                          });
                        },
                        text: 'Edit',
  ...
  Future<dynamic> dialogEditPractioner(
      BuildContext context, WidgetRef ref, Practioner practioner) {
    double screenWidth = MediaQuery.of(context).size.width;
    double width = ResponsiveWidget.isphoneScreen(context)
        ? 414
        : ResponsiveWidget.isSmallScreen(context)
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  await service
                                      .updatePractioners(practionerData);
  ...
  void dispose() {
    ...
    _firstNamePractioner.dispose();
    _lastNamePractioner.dispose();
    _myApproachPractioner.dispose();
    _myBackgroundPractioner.dispose();
    _myQualificationsPractioner.dispose();
    _mySpecialtyPractioner.dispose();
    _myRolesPractioner.dispose();
    _languagesPractioner.dispose();
    _titleMainPractioner.dispose();
    _schedulePractioner.dispose();
    super.dispose();
  }
}
