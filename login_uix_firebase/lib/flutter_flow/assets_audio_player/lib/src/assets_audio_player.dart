// ignore_for_file: depend_on_referenced_packages, unnecessary_import, constant_identifier_names, prefer_const_declarations, prefer_const_constructors, avoid_print, prefer_interpolation_to_compose_strings
      ...
      try {
        final params = {
          ...
          'playSpeed': playSpeed ??
              ...
              defaultPlaySpeed,
          'pitch': pitch ?? audio.pitch ?? this.pitch.value ?? defaultPitch,
        };
        if (seek != null) {
